    ...
    <div class="content">
      <div class="left-side">
        <div class="address details" >
          ...
          <div class="text-one">Bustos Bulacan</div>
          <div class="text-two">Philippines</div>
        </div>
        <div class="phone details">
          <i class="fas fa-phone-alt"></i>
          <div class="topic">Phone</div>
          <div class="text-one">09054112515</div>
          <div class="text-two">09653169944</div>
          <div class="text-two">09764192198</div>
        </div>
        <div class="email details">
          <i class="fas fa-envelope"></i>
          <div class="topic">Email</div>
          <div class="text-one">lanceandreir@gmail.com</div>
          <div class="text-two">chryslerjohnmaniego@gmail.com</div>
          <div class="text-two">alvincruz210@gmail.com8</div>
        </div>
      </div>
